...
def points_vie_attaque_défense(...,defense,attaque):
    if attaque > defense:
        points_vie = ...
        if points_vie < ...:
            points_vie = ...
...
def points_vie_attaque_défense(points_vie, defense, attaque):
    if attaque > defense:
...
"""
# --- PYODIDE:tests --- #
assert points_vie_attaque_défense(100,40,110) == 30
assert points_vie_attaque_défense(100,40,20) == 100
assert points_vie_attaque_défense(100,40,40) == 100
assert points_vie_attaque_défense(100,40,300) == 0
