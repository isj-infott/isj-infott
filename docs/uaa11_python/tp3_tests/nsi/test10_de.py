...
def grade(points_exp):
    if points_exp < 100 :
        return 'padawan'
    elif points_exp < 400 :
        return 'chevalier'
    elif points_exp < 1500 :
        return 'maître'
    else:
        return 'grand maître'
...
def tests():
    assert grade(15) == 'padawan'
    assert grade(99) == 'padawan'
    assert grade(100) == 'chevalier'
    assert grade(365) == 'chevalier'
    assert grade(865) == 'maître'
    assert grade(1500) == 'grand maître'
