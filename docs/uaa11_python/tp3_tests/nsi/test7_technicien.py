...
def facture_intervention(nb_heures):
    if nb_heures <= 2 :
        return 150
    else:
        return 150+40*(nb_heures-2)
...
assert facture_intervention(1.5) == 150
assert facture_intervention(2) == 150
assert facture_intervention(2.5) == 170.0
assert facture_intervention(4) == 230
