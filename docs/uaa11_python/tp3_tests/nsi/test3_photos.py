...
def prix_développement(nb_photos):
    if nb_photos ... :
        return nb_photos*0.16
    else:
        return ...
...
assert prix_développement(10) == 1.6
assert prix_développement(75) == 9.0
assert prix_développement(80) == 9.6
