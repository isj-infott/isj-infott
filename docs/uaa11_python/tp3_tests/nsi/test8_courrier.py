...
# Question 1
assert affranchissement(15) == 1.66
assert affranchissement(53) == 2.82
assert affranchissement(250) == 4.5
# Question 2
assert affranchissement(365) == 6.5
# Question 3
def affranchissement(poids):
    if poids <= 20:
        return 1.66
...
assert affranchissement(10) == 1.66
assert affranchissement(70) == 2.82
assert affranchissement(190) == 4.5
assert affranchissement(380) == 6.5
assert affranchissement(501) == 8
