...
assert test4([['hello', 'there'], ['comment', 'allez', 'vous']]) == [['hello', 'there','are'], ['how', 'allez', 'vous']]
...
def tests():
    assert test4([['salut', 'there'], ['comment', 'are', 'you']]) == [['salut', 'there','are'], ['how', 'are', 'you']]
