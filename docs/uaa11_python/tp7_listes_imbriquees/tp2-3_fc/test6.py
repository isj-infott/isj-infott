...
assert test6(chaines, "hello") == ["hello there", "hello world"]
assert test6(chaines, "goodbye") == ["goodbye world"]
assert test6(chaines, "python") == []
