...
assert test8(chaines, "Python") == False
assert test8(chaines, "hello") == True
assert test8(chaines, "hello there") == True
assert test8(chaines, "hello world") == True
