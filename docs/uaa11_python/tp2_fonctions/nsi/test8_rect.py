...
def perimetre_rectangle(longueur, ...):
    ...
    return ...   

# ecris ici l'instruction pour le périmètre du rectangle 1
print(perimetre_rectangle(5, ...))
...
print(perimetre_rectangle(5, 4))
print(perimetre_rectangle(10, 3.5))
print(perimetre_rectangle(12.5, 7))
...
"""
# --- PYODIDE:tests --- #
# ecris ici l'instruction pour le périmètre du rectangle 2
...
# ecris ici l'instruction pour le périmètre du rectangle 3
...
...
def tests():
    assert perimetre_rectangle(5, 4) == 18
    assert perimetre_rectangle(10, 3.5) == 27
    assert perimetre_rectangle(12.5, 7) == 39
    assert perimetre_rectangle(2, 2) == 8
