...
def tests():
    assert nb_1er(24) == False
    assert nb_1er(0) == False
    assert nb_1er(1) == False
    assert nb_1er(2) == False
    assert nb_1er(6) == False
    assert nb_1er(13) == True
    assert nb_1er(28) == False
    assert nb_1er(1093) == True
