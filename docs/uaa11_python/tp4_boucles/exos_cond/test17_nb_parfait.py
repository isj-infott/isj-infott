...
def tests():
    assert nb_parfait(24) == False
    assert nb_parfait(0) == False
    assert nb_parfait(1) == False
    assert nb_parfait(2) == False
    assert nb_parfait(6) == True
    assert nb_parfait(13) == False
    assert nb_parfait(28) == True
    assert nb_parfait(1093) == False
