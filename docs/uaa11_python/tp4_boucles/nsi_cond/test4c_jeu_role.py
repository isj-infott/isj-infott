...
# def nb_attaques_aleatoires_points_vie_defense(points_vie,defense,val_min_attaque,val_max_attaque):
#     ...
...
def points_vie_attaques_aleatoires_multiples_defense(points_vie,defense,nb_attaques,val_min_attaque,val_max_attaque):
    while points_vie > 0 :
        attaque = randint(val_min_attaque, val_max_attaque)
        if attaque > defense :
            points_vie -= (attaque - defense)
        nb_attaques+=1
        print("debug; ", attaque, points_vie, nb_attaques)
    return nb_attaques   
...
def tests():
    print(points_vie_attaques_aleatoires_multiples_defense(250, 25, 5, 10, 40))
