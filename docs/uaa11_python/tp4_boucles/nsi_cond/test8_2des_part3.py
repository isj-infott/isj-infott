...
def nb_lancers_deux_des_double_six_deux_fois():
...
def nb_lancers_deux_des_double_six_deux_fois():
    ...
    while nb_double_six < 2 :
        ...
        face_de1 = randint(1,6)
        face_de2 = randint(1,6)
        if face_de1 == 6 and face_de2 ==6 :
            nb_double_six = nb_double_six +1
        print(nb_lancers, nb_double_six, face_de1, face_de2)
    return nb_lancers
...
def tests():
    print(nb_lancers_deux_des_double_six_deux_fois())
