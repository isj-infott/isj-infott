...
def nb_lancers_deux_des_double_six():
    ...

def nb_lancers_deux_des_double_quatre():
    ...

# Code optimisé
def nb_lancers_deux_des_double(face) :
    ...
...
def nb_lancers_deux_des_double_six() :
    nb_lancers = 0
    face1, face2 = 0,1
    while face1 != 6 or face2 != 6:
        nb_lancers = nb_lancers +1
        face1 = randint(1,6)
        face2 = randint(1,6)
        print(nb_lancers, face1, face2)
    return nb_lancers

def nb_lancers_deux_des_double_quatre() :
    nb_lancers = 0
    face1, face2 = 0,1
    while face1 != 4 or face2 != 4:
        nb_lancers = nb_lancers +1
        face1 = randint(1,6)
        face2 = randint(1,6)
        print(nb_lancers, face1, face2)
...
def nb_lancers_deux_des_double(face) :
    nb_lancers = 0
    face1, face2 = 0,1
    while face1 != face or face2 != face:
        nb_lancers = nb_lancers +1
        face1 = randint(1,6)
        face2 = randint(1,6)
        print(nb_lancers, face1, face2)
...
print(nb_lancers_deux_des_double_six())
print(nb_lancers_deux_des_double_quatre())

print(nb_lancers_deux_des_double(6))
print(nb_lancers_deux_des_double(4))
