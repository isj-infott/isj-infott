...
# --- PYODIDE:corr --- #
"""
Pour comprendre le code, affiche les variables à chaque passage dans la
boucle while : 
print(nb_annees, somme)
2000 augmente de 2% /  an jusqu'à atteindre 3000.
Cela pourrait correspondre à 2000€ placés à la banque à un taux d'intérêts de 2% 
"""    
# --- PYODIDE:ignore --- #
"""
