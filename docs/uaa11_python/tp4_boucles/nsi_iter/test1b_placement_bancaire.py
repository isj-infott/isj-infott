...
def placement_bancaire(somme_ini, taux, annees):
    somme = somme_ini
...
"""
# --- PYODIDE:tests --- #
assert placement_bancaire(2000,2,20) == 2971.89
assert placement_bancaire(4000,2,15) == 5383.47
assert placement_bancaire(3000,1.75,10) == 3568.33
